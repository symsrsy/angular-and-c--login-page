...
namespace deepworkapi.Controllers
{
    ...
    public class RCPracticeController : ControllerBase
    {
        ...
        [HttpGet("personnel-role")]
        [Authorize(Roles = "Personnel")]

        public IActionResult PersonnelRole()
        {
            return Ok("personnel role");
        }

        [HttpGet("manager-or-personnel-role")]
        [Authorize(Roles = "Manager,Personnel")]

        public IActionResult Admin()
        {
            return Ok("Manager or Personnel role");
        }
        ...
        [HttpGet("personnel-policy")]
        [Authorize(policy: "PersonnelPolicy")]

        public IActionResult PersonnelPolicy()
        {
            return Ok("personnel policy");
        }
        ...
        [HttpGet("work-surname-policy")]
        [Authorize(policy: "WorkSurnamePolicy")]

        public IActionResult WorkSurnamePolicy()
        {
            return Ok("work surname policy");
        }

        [HttpGet("manager-email-and-work-surname-policy")]
        [Authorize(policy: "ManagerEmailAndWorkSurnamePolicy")]

        public IActionResult ManagerEmailAndWorkSurnamePolicy()
        {
            return Ok("manager email and work surname policy");
        }
